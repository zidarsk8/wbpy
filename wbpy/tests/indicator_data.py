...
class TestData(object):
    ...
    def __init__(self):
        self.dataset = wbpy.IndicatorDataset(
            self.response, self.url, self.date)


class Yearly(TestData):
    url = "api.worldbank.org/countries/GB;AR;SA;HK/indicators/SP.POP.TOTL?format=json&per_page=1000&mrv=2"  # noqa
    ...
    indicator = {
        ...
        "sourceNote": ("Total population is based on the de facto definition "
                       ...
                       "not permanently settled in the country of asylum, who "
                       "are generally considered part of the population of "
                       "their country of origin. The values shown are midyear "
                       "estimates."),
        "sourceOrganization": ("(1) United Nations Population Division. World "
                               "Population Prospects, (2) United Nations "
                               ...
                               "Statistics and Demography Programme, and (6) "
...
class Monthly(TestData):
    url = "api.worldbank.org/en/countries/ind;chn/indicators/DPANUSSPF?MRV=7&frequency=M&format=json"  # noqa
    date = datetime.date(2013, 9, 19)
    response = [
        ...
        [
            {
                "indicator": {
                    "id": "DPANUSSPF",
                    "value": "Exchange rate, old LCU per USD extended "
                    "forward, period average"
                },
                "country": {
                    "id": "CN",
                    "value": "China"
    ...
    indicator = {
        ...
        "id": "DPANUSSPF",
        "name": "Exchange rate, old LCU per USD extended "
        "forward, period average",
        "source": {
            "id": "15",
            "value": "Global Economic Monitor"
        },
        "sourceNote": "Local currency units (LCU) per U.S. dollar, with "
        "values after a new currency's introduction presented in the old "
        "currency's terms",
        "sourceOrganization": "World Bank staff calculations based on "
        "Datastream and IMF International Finance Statistics data.",
        "topics": [
            {}
        ]
...
class Quarterly(TestData):
    url = "api.worldbank.org/en/countries/es/indicators/NEER?MRV=10&frequency=Q"  # noqa
    date = datetime.date(2013, 9, 19)
    response = [
    ...
    indicator = {
        ...
        "sourceNote": "A measure of the value of a currency against a "
