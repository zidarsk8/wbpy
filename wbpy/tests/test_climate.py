...
import wbpy
from wbpy.tests.climate_data import InstrumentalMonth
from wbpy.tests.climate_data import InstrumentalYear
from wbpy.tests.climate_data import InstrumentalDecade
